		...
		@foreach($patrocinadores as $key => $patrocinador)
			<div class="col-md-12 lista" id="list{{$patrocinador->id}}">
			    ...
			    <div id="pre-view{{$key}}" class="col-md-3 delete-img-container" style="margin-top:3%	">
			    	<img id="blah{{$key}}" src="/{{$patrocinador->imagen}}" alt="your image" style="height:100px; width:auto;">
			    </div>
			    <div class='form-group col-md-4'>
			        <textarea name="titulo" class="form-control newtextarea">{{$patrocinador->titulo}}</textarea>
			    </div>
